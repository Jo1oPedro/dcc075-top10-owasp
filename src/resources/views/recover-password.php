...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <form class="space-y-6" action="/recover-password" method="POST">
            <div>
            ...
            <div>
                <div class="flex items-center justify-between">
                    <label for="recover_password" class="block text-sm font-medium leading-6 text-gray-900">Recover password question. Your dog's name</label>
                </div>
                <div class="mt-2">
                    <input id="recover_password" name="recover_password" type="text" required class="px-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>
            </div>
